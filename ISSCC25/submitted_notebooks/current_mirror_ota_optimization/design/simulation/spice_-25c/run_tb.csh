...
set input_file = "$ROAR_DESIGN/cm_ota/simulation/spice_-25c/tb_cm_ota.sp"
set output_file = "$ROAR_DESIGN/cm_ota/simulation/spice_-25c/tb_cm_ota_preprocessed.sp"
set log_file = "$ROAR_DESIGN/cm_ota/simulation/spice_-25c/output.log"
