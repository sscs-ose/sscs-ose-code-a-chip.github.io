...
"}
C {cm_ota.sym} 300 -260 0 0 {name=X1 w1_2=0.840 w3_4=0.560 w5_6=3.78 w7_8=2.52}
C {devices/code.sym} 710 -140 0 0 {name=s1 only_toplevel=false value="
.temp 27
.ac dec 100 1 1e15
.option savecurrents
.save all
...
.control
	...
	plot cph(out) vs frequency
	op
	write tb_cm_ota_working_v2.raw
...
.endc
"}
C {devices/isource.sym} 400 -220 0 0 {name=I2 value=10.05u}
