...
"
spice_ignore=false}
C {cm_ota.sym} 300 -260 0 0 {name=X1 w1_2=5.88 w3_4=10.08 w5_6=19.32 w7_8=35.28 w9_10=11.76 nf1_2=1 nf3_4=1 nf5_6=1 nf7_8=1 nf9_10=1 beta=1 }
...
.endc
"}
C {devices/lab_pin.sym} 400 -260 2 0 {name=p5 sig_type=std_logic lab=itail
}
C {devices/lab_pin.sym} 80 -360 0 0 {name=p6 sig_type=std_logic lab=vdd}
C {devices/isource.sym} 400 -220 2 0 {name=I3 value=13.1u}
C {devices/gnd.sym} 400 -190 0 0 {name=l8 lab=GND}
