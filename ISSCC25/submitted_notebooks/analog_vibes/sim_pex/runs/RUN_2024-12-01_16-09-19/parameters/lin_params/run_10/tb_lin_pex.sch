...
let HD2=H1-H2
let HD3=H1-H3 
echo $&HD2 $&HD3 > /home/sscspico/test_tools/coc_analog_vibes/ISSCC25/submitted_notebooks/analog_vibes/sim_pex/runs/RUN_2024-12-01_16-09-19/parameters/lin_params/run_10/tb_lin_pex_10.data
quit
...
C {devices/code_shown.sym} 600 -520 0 0 {name=SETUP only_toplevel=false value=".temp -40"
}
