...
C {devices/vsource.sym} 430 -160 0 0 {name=V2 value=1.2 savecurrent=false}
...
C {devices/vsource.sym} 530 -160 0 0 {name=V3 value="sin(0 0.4 1035.15625 0 0 45.0)" savecurrent=false}
...
let HD2=H1-H2
let HD3=H1-H3 
echo $&HD2 $&HD3 > /home/sscspico/test_tools/coc_analog_vibes/ISSCC25/submitted_notebooks/analog_vibes/sim_pex/runs/RUN_2024-12-01_16-10-40/parameters/lin_params/run_34/tb_lin_pex_34.data
quit
...
C {devices/code_shown.sym} 600 -520 0 0 {name=SETUP only_toplevel=false value=".temp 125"
}
