...
C {devices/isource.sym} 210 -160 0 0 {name=I1 value=10u}
...
C {devices/isource.sym} 300 -160 0 0 {name=I2 value=10u}
...
C {sky130_fd_pr/corner.sym} 730 -450 0 0 {name=CORNER only_toplevel=false corner=tt}
C {devices/code_shown.sym} 370 -490 0 0 {name=CONTROL only_toplevel=false value=".control
ac dec 20 1 1e12
save all
plot db(mag(v(VOUT))) 180/pi*ph(v(VOUT))
.endc"
}
...
C {ota_pex.sym} 140 -390 0 0 {name=x1}
