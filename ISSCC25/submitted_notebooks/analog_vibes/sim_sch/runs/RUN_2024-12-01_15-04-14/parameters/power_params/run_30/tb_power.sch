...
C {devices/vsource.sym} 130 -160 0 0 {name=V1 value=1.7 savecurrent=false}
...
let power_ota_core = 1.7*(@m.x1.xm1.msky130_fd_pr__pfet_01v8_lvt[id] + @m.x1.xm2.msky130_fd_pr__pfet_01v8_lvt[id] + @m.x1.xm9.msky130_fd_pr__pfet_01v8_lvt[id] + @m.x1.xm10.msky130_fd_pr__pfet_01v8_lvt[id] + @m.x1.xm14.msky130_fd_pr__pfet_01v8_lvt[id] + @m.x1.xm12.msky130_fd_pr__pfet_01v8_lvt[id])
let power_tot = -1*1.7*i(V1)
let power_ota_bias = power_tot-power_ota_core
echo $&power_tot $&power_ota_core $&power_ota_bias > /home/sscspico/test_tools/coc_analog_vibes/ISSCC25/submitted_notebooks/analog_vibes/sim_sch/runs/RUN_2024-12-01_15-04-14/parameters/power_params/run_30/tb_power_30.data
quit
