...
C {devices/vsource.sym} 130 -160 0 0 {name=V1 value=1.8 savecurrent=false}
...
C {devices/isource.sym} 210 -160 0 0 {name=I1 value=9.999999999999999e-06}
...
C {devices/vsource.sym} 600 -160 0 0 {name=V2 value=1.2 savecurrent=false}
...
C {devices/vsource.sym} 680 -160 0 0 {name=V3 value=0 savecurrent=false}
...
C {sky130_fd_pr/corner.sym} 400 -480 0 0 {name=CORNER only_toplevel=false corner=fs}
C {devices/code_shown.sym} 630 -530 0 0 {name=CONTROL only_toplevel=false value=".control
op
save all
...
let power_ota_core = 1.8*(@m.x1.xm1.msky130_fd_pr__pfet_01v8_lvt[id] + @m.x1.xm2.msky130_fd_pr__pfet_01v8_lvt[id] + @m.x1.xm9.msky130_fd_pr__pfet_01v8_lvt[id] + @m.x1.xm10.msky130_fd_pr__pfet_01v8_lvt[id] + @m.x1.xm14.msky130_fd_pr__pfet_01v8_lvt[id] + @m.x1.xm12.msky130_fd_pr__pfet_01v8_lvt[id])
let power_tot = -1*1.8*i(V1)
let power_ota_bias = power_tot-power_ota_core
echo $&power_tot $&power_ota_core $&power_ota_bias > /home/sscspico/test_tools/coc_analog_vibes/ISSCC25/submitted_notebooks/analog_vibes/sim_sch/runs/RUN_2024-12-01_15-04-14/parameters/power_params/run_40/tb_power_40.data
quit
...
C {devices/code_shown.sym} 630 -580 0 0 {name=SETUP only_toplevel=false value=".temp 130"
}
C {devices/isource.sym} 300 -160 0 0 {name=I2 value=9.999999999999999e-06}
