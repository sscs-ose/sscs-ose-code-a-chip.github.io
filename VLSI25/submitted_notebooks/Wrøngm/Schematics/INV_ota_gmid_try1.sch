...
N 60 -140 60 -100 {lab=GND}
N 60 -240 60 -200 {lab=#net1}
N 60 -350 60 -300 {lab=Vin}
...
C {code.sym} 30 -650 0 0 {name=NGSPICE only_toplevel=false value="
...
plot @c1[i]
wrdata /foss/designs/CAC/Inverter-OTA/inv-OA-try1_Error2.txt v(vout) v(vx) v(vin) @n.xmp_stg3.nsg13_hv_pmos[ids]  @n.xmn_stg3.nsg13_hv_nmos[ids] @c1[i]
.endc
"
}
C {vsource.sym} 60 -170 0 0 {name=Vin2 value=0.66 savecurrent=false}
C {gnd.sym} 60 -100 0 0 {name=l3 lab=GND}
C {ngspice_probe.sym} 60 -210 0 1 {name=r2}
C {vsource.sym} 60 -270 0 0 {name=Vin3 value=" PULSE(0 0.33 1p 10n 10n 0.75u 1.5u 4)" savecurrent=false}
